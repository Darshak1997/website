...
<div id="wrapper">
	...
	<div class="vertical-menu">
	  	<a href="proyectos_login.php" class="active">Proyectos</a>
	...
	$sql = "SELECT id, image, name, description, start FROM projects";
    ...
    if(mysqli_num_rows($result) > 0){
        ...
        while($row = mysqli_fetch_array($result)){
            echo "<tr>";
                ...
                echo "<td style='border: 1px solid #ddd; text-align: left; padding: 15px;'>" . '<a href="edit_proj.php" class="button_echo">Edit</a>' . "</td>";
                echo "<td style='border: 1px solid #ddd; text-align: left; padding: 15px;'>" . '<a href="del_proj.php" class="button_echo">Delete</a>' . "</td>";
            echo "</tr>";
        }
        echo "</table>";
        echo '<a href="add_project.php" class="button_echo">Add</a>';
        // Free result set

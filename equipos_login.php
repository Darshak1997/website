...
<div id="wrapper">
		...
		<center>
			<nav>
				...
				<a href="" class="h" class="selected">Eventos</a>
	...
	<div class="vertical-menu">
	  	...
	  	<a href="videos_login.php">Videos</a>
	  	<a href="eqipos_login.php" class="active">Equipo</a>
	</div>
    ...
    if(mysqli_num_rows($result) > 0){
        echo "<table style='border: 1px solid #ddd; text-align: left; border-collapse: collapse; width:100%;'>";
            echo "<tr style='color: red;'>";
                ...
                echo "<th style='border: 1px solid #ddd; text-align: left; padding: 15px;'>Image </th>";
                ...
                echo "<th style='border: 1px solid #ddd; text-align: left; padding: 15px;'>Phone Number</th>";
                echo "<th style='border: 1px solid #ddd; text-align: left; padding: 15px;'>Email</th>";
            echo "</tr>";
        while($row = mysqli_fetch_array($result)){
            echo "<tr>";
            	echo "<td style='border: 1px solid #ddd; text-align: left; padding: 15px;'>" . $row['id'] . "</td>";
                echo "<td style='border: 1px solid #ddd; text-align: left; padding: 15px;'>" . $row['image'] . "</td>";
                ...
                echo "<td style='border: 1px solid #ddd; text-align: left; padding: 15px;'>" . $row['phone'] . "</td>";
                echo "<td style='border: 1px solid #ddd; text-align: left; padding: 15px;'>" . $row['email'] . "</td>";
                echo "<td style='border: 1px solid #ddd; text-align: left; padding: 15px;'>" . '<a href="edit_equipo.php" class="button_echo">Edit</a>' . "</td>";
                echo "<td style='border: 1px solid #ddd; text-align: left; padding: 15px;'>" . '<a href="del_euipo.php" class="button_echo">Delete</a>' . "</td>";
            echo "</tr>";
        }
        echo "</table>";
        echo '<a href="add_equipo.php" class="button_echo">Add</a>';
        // Free result set

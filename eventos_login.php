...
<div id="wrapper">
	...
	<div class="vertical-menu">
	  	...
	  	<a href="eventos_login.php" class="active">Eventos</a>
	...
	$sql = "SELECT id, image, name, description, start FROM events";
    ...
    if(mysqli_num_rows($result) > 0){
        echo "<table style='border: 1px solid #ddd; text-align: left; border-collapse: collapse; width:100%;'>";
            echo "<tr style='color: red;'>";
                ...
                echo "<th style='border: 1px solid #ddd; text-align: left; padding: 15px;'>Start</th>";
            echo "</tr>";
        while($row = mysqli_fetch_array($result)){
            echo "<tr>";
                ...
                echo "<td style='border: 1px solid #ddd; text-align: left; padding: 15px;'>" . $row['start'] . "</td>";
                echo "<td style='border: 1px solid #ddd; text-align: left; padding: 15px;'>" . '<a href="edit_eventos.php" class="button_echo">Edit</a>' . "</td>";
                echo "<td style='border: 1px solid #ddd; text-align: left; padding: 15px;'>" . '<a href="del_eventos.php" class="button_echo">Delete</a>' . "</td>";
            echo "</tr>";
        }
        echo "</table>";
        echo '<a href="add_eventos.php" class="button_echo">Add</a>';
        // Free result set

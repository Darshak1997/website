...
<div id="wrapper">
	<header>
		<center>
			...
			<a href="./inicio.php" class= "selected">Inicio</a>
		...
		<div id="sec1">
			<div id="sec1div1">
				<img id="logosec1" src="./imagen P1/logo.png">
				<h2 id="title1">CENTRO AGUSTO <br>MIJARES<h3 id="title2">DESARROLLO DE <br>HUMANO</h3></h2>
			</div>
			<div id="bisec">
				<h3 id="biodata">BIENVENIDA</h3>
				<p id="biodatadesc">						
		...
		<div id="sec2">
			<img id="sec2img" src="./imagen P1/logo.png" height="55" width="55" align="middle">
			<h3 id="proposito" align="middle">PROPOSITO</h3>
			<p id="propositodesc" align="middle">
		...
		<div id="sec3">
			...
			<br>
			<br>
			<video id="iframeinicio" width="400" height="200" src="https://youtu.be/Kcl-T98Wtvo" controls></video>
			<h3 id="objetivos">OBJETIVOS</h3>
			<p id="objetivosdesc">						
					1. Funcionar como punto de información en el tema de la Responsabilidad Social.
					<br>2. Establecer alianzas en línea para la realización de actividades en por del desarrollo humano ustentable.
					<br>3. Dar a conocer los trabajos realizados, en el campo de la Responsabilidad Social - Desarrollo Sustentable, por los miembros del Centro Augusto Mijares y otras personas interesadas en el tema.
					<br>4. Funcionar como un centro de información para la reflexión sobre el tema de la Responsabilidad Social.
					Nota en el punto objetivos se uso ula lista esto no se hizo a mano.
				</p>
		</div>
		<br>
		<br>
